...
const initialCustomers: Customer[] = [
  { id: uuidv4(), name: 'Sammed', email: 'sammed@gmail.com', phoneNumber: '1234567890', message: "this is the john doe" },
  { id: uuidv4(), name: 'John', email: 'john@example.com', phoneNumber: '9236467890', message: "this is the john doe" },
];
